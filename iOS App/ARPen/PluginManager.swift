...
class PluginManager: ARManagerDelegate, PenManagerDelegate {
    ...
    var plugins: [Plugin] = [PaintPlugin(), PrecisionTestPlugin(), PenSelectionWithHighlightingPlugin(), PenSelectionWithoutHighlightingPlugin(), OnehandedTouchPlugin(), TwohandedTouchPlugin()]
