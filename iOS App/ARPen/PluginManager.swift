...
class PluginManager: ARManagerDelegate, PenManagerDelegate {
    ...
    var plugins: [Plugin] = [PaintPlugin(), PrecisionTestPlugin(), PenSelectionWithoutHighlightingPluginTest(), PenSelectionWithHighlightingPluginTest(), OnehandedTouchPluginTest(), TwohandedTouchPluginTest(), PenRaySelectionPluginTest(), PenSelectionWithoutHighlightingPlugin(), PenSelectionWithHighlightingPlugin(),  OnehandedTouchPlugin(), TwohandedTouchPlugin(), PenRaySelectionPlugin()]
