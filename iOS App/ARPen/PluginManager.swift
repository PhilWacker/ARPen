...
class PluginManager: ARManagerDelegate, PenManagerDelegate {
    ...
    var plugins: [Plugin] = [PaintPlugin(), PrecisionTestPlugin(), PenSelectionWithoutHighlightingPluginTest(), PenSelectionWithHighlightingPluginTest(), OnehandedTouchPluginTest(), TwohandedTouchPluginTest(), PenSelectionWithoutHighlightingPlugin(), PenSelectionWithHighlightingPlugin(),  OnehandedTouchPlugin(), TwohandedTouchPlugin()]
