...
class OnehandedTouchPluginTest: Plugin {
    var recordManager: UserStudyRecordManager!
    
    var pluginImage : UIImage? = UIImage.init(named: "TrialPlugin")
    var pluginIdentifier: String = "OnehandedTouchTrial"
    ...
    @objc func handleTap(_ sender:UITapGestureRecognizer){
        if sender.state == .began{
            ...
            if let activeTargetBox = self.activeTargetBox {
                ...
                //self.saveDateEntry(withTarget: activeTargetBox, touchPoint: touchPoint, andHitTestResults: hitResults)
    ...
    func saveDateEntry(withTarget box : ARPenBoxNode, touchPoint: CGPoint, andHitTestResults hitTestResults : [SCNHitTestResult]) {
        ...
        if isOnRay {
            ...
            deviation = self.distance(ofPoint: touchPoint, toProjectedBox: projectionArray)
        }
    ...
    //normal callback function not needed for this plugin
